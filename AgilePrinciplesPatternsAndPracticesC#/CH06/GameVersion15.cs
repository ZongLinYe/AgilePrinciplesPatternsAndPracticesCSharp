...
namespace AgilePrinciplesPatternsAndPracticesC_.CH06
{
    ...
    /// Game 只管 輪
    /// </summary>
    public class GameVersion15
    {
        private int _currentFrame = 1;
        private bool _isFirstThrow = true;
        private ScorerVersion15 scorer = new ScorerVersion15();
        ...
        private bool LastBallInfFrame(int pins)
        {
