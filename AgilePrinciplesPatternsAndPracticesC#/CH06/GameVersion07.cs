    ...
    public class GameVersion07
    {
        ...
        public int ScoreForFrame(int theFrame)
        {
                ...
                currentFrame++)
            {
                ...
                {
                    HandleSecondThrow(ref score, ref ball, firstThrow);
                }
        ...
        private void HandleSecondThrow(ref int score, ref int ball, int firstThrow)
        {
            int secondThrow = _throws[ball+1];
